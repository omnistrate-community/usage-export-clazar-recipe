...
- `memory_byte_hours_total_price`: Unit count * Price per unit for the Memory byte hour dimension
- `storage_allocated_byte_hours_total_price`:  Unit count * Price per unit for the Storage usage in byte-hours hour dimension
- `cpu_core_hours_total_price`:  Unit count * Price per unit for the CPU core usage hour dimension
- `replica_hours_total_price`:  Unit count * Price per unit for the Replica usage hour dimension
